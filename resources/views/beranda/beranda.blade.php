            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p class="lead">Mobilokal, Portal terkemuka di Indonesia mempermudah dan mempercepat <span
                                class="accent-color">Pembelian dan Penjualan Mobil</span> baik mobil baru maupun mobil bekas
                        </p>
                    </div>
                    <div class="col-md-6">
                        {!! Form::open(['url' => 'spesifikasi-mobil-baru', 'method' => 'post']) !!}
                        <!-- kota -->
