        ...
        <div class="carousel-wrapper">
            <div class="row">
                <ul class="owl-carousel carousel-fw" id="vehicle-slider" data-columns="4" data-autoplay="" data-pagination="yes" data-arrows="no" data-single-item="no" data-items-desktop="4" data-items-desktop-small="3" data-items-tablet="2" data-items-mobile="1">
                    <!-- foreach mobil baru-->
                    @php
                    $newcar = \App\SpesifikasiMobilBaru::all();
//                    return $newcar;
                    @endphp
{{--                    return $newcar;--}}
                    ...
                    <li class="item">
                        <div class="vehicle-block format-standard">
                            <a href="/mobil-baru/{{$value->city->slug}}/{{$value->slug}}" class="media-box"><img src="/img/mobil-baru/{{$value->foto}}" alt=""></a>
                            <div class="vehicle-block-content">
                                <span class="label label-default vehicle-age">Mobil Baru</span>
                                <span class="label label-danger premium-listing">{{$value->merek->merek}} | {{$value->city}}</span>
                                <h5 class="vehicle-title"><a href="/mobil-baru/{{$value->city_slug}}/{{$value->slug}}">{{$value->design->design}} {{$value->tipe->tipe}}</a></h5>
