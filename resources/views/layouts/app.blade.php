                  ...
                  <div class="col-md-4 col-sm-6 footer_widget widget widget_custom_menu widget_links">
                      <h4 class="widgettitle">Hubungi Kami</h4>
                        <ul>
                          ...
                          <li><i class="fa fa-map-marker"></i>&nbsp;&nbsp;&nbsp;WTC Mangga Dua, Jl. Mangga Dua Raya No.8, RW.5, Ancol, Kec. Pademangan,  14430</li>
                          <li><i class="fa fa-map-marker"></i>&nbsp;&nbsp;&nbsp;Kota Jkt Utara - Daerah Khusus Ibukota Jakarta</li>
...
APPLY SEKARANG JUGA.
kt88cars, Portal terkemuka di Indonesia mempermudah dan mempercepat Pembelian dan Penjualan Mobil baik mobil baru maupun mobil bekas.</p>
                    </div>
                </div>
            </div>
      </div>
